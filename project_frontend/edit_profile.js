...
function openModal(field) {
   ...
   newConfirmBtn.addEventListener('click', function() {
      ...
      const newValue = inputField.value;
         ...
         const newValue = inputField.value;
         updateEmail(username, newValue).then(() => {user.email = newValue});
      }else if(field ==="First Name"){
         const newValue = inputField.value;
         updateFirstName(username, newValue).then(() => {user.firstName = newValue});
      }else if(field === "Last Name"){
         const newValue = inputField.value;
         updateLastName(username, newValue).then(() => {user.lastName = newValue});
      }else if(field === "Phone"){
         const newValue = inputField.value;
         updatePhoneNumber(username, newValue).then(() => {user.phoneNumber = newValue});
      }
